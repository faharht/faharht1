  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">{t("err.404Desc")}</p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">{t("err.bootDesc")}</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn Russian with structured sentence lists, audio, and transliterations." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Russian Master" },
      { property: "og:description", content: "Learn Russian with structured sentence lists, audio, and transliterations." },

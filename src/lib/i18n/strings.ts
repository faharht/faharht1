...
export const STRINGS = {
  ...
  "guestLock.toast":        { en: "Sign in to unlock all sentences.",      pl: "Zaloguj się, aby odblokować wszystkie zdania.", de: "Melde dich an, um alle Sätze freizuschalten." },
  "guestLock.cardTitle":    { en: "Sign in to unlock",                     pl: "Zaloguj się, aby odblokować", de: "Anmelden zum Freischalten" },
  "guestLock.cardHint":     { en: "Guests can play the first 50 sentences. Sign in or create a free account to play the rest.", pl: "Goście mogą odtworzyć pierwsze 50 zdań. Zaloguj się lub załóż darmowe konto, aby odtworzyć resztę.", de: "Gäste können die ersten 50 Sätze abspielen. Melde dich an oder erstelle ein kostenloses Konto für den Rest." },
